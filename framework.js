...
const FRAMEWORK = (() => {
  ...
  const results = [
    ...
    },
    {
      ...
      checkInField: "Observe lessons; review IEPs and lesson plans; check inclusive materials; interview teachers and learners; verify mentoring and follow-up.",
      evidence: "Training registers; pre/post tests; lesson plans; IEPs; classroom observation forms; mentoring reports; materials inventory; learner feedback.",
    },
    {
  ...
  const fieldQuestions = [
    ...
    { id: "FV-08", result: "R2", area: "Classroom practice", question: "Does observation show child-centred/inclusive teaching, adaptation and participation of learners with disabilities?", standard: "Quality inclusive education" },
